...
export const LocationHours = () => {
  return (
    <section 
      className="w-full flex flex-col items-center justify-center relative opacity-100 "
      style={{ 
        position:'absolute',
      ...
      >
        ...
        >
          ...
          <div 
            ...
            style={{
              width: '680px', // Figma xəritə eni
              height: '927px', // Figma xəritə hündürlüyü
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <h3 className="flex items-center gap-2" style={{ fontFamily: "'Poppins', sans-serif",
                 fontWeight: 600, 
                 fontSize: '18px', 
                 color: '#6F4E37' }}>
                <img src={phoneIcon} className="w-5 h-5 object-contain" style={{ opacity: 0.6 }} />
                 Get in Touch
              </h3>
